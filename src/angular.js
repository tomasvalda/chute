/**
 * @license AngularJS v1.4.0-local+sha.4501da3
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message += '\nhttp://errors.angularjs.org/1.4.0-local+sha.4501da3/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.4.0-local+sha.4501da3',    // all of these placeholder strings will be replaced by grunt's
